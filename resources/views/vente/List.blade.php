        ...
        <div class="container-fluid ">
            ...
            <div class="widget-content searchable-container list">
                <div class="card card-body">
                    <h5 class="card-title border p-2 bg-light rounded-2 mb-4">Information client par commande N° {{$bonVente->id}}</h5>
                    <div class="row">
                        <div class="col-md-12 col-xl-6">
                            <div class="form-group">
                                <div class="mb-4">
                                    <label for="" style="min-width: 115px">Nom client :</label>
                                    <span class="border p-2 bg-light rounded-2">{{$Client->first_name}} {{$Client->last_name}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-xl-6">
                            <div class="form-group">
                                <div class="mb-4">
                                    ...
                                    <span class="border p-2 bg-light rounded-2">{{$Client->Telephone}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card card-body">
                <h5 class="card-title border p-2 bg-light rounded-2">Fiche détail vente </h5>
                        ...
                        <tbody>
                            ...
                            @foreach ($Data_Vente as $value)
                                ...
                                <tr>
                                    <td>{{$value->name}}</td>
                                    <td>{{$value->qte}}</td>
                                    <td class="text-end">{{ number_format($value->price_vente, 2, ',', ' ') }}</td>
